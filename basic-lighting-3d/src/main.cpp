...
int main() {
    ...
    GLuint object_color_uniform =
        glGetUniformLocation(lighting_shader_program.ID, "u_object_color");
    GLuint light_color_uniform =
        glGetUniformLocation(lighting_shader_program.ID, "u_light_color");
    GLuint light_pos_uniform =
        glGetUniformLocation(lighting_shader_program.ID, "u_light_pos");
    GLuint view_pos_uniform =
        glGetUniformLocation(lighting_shader_program.ID, "u_view_pos");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glUniformMatrix4fv(
            glGetUniformLocation(lighting_shader_program.ID, "u_projection"), 1,
            GL_FALSE, glm::value_ptr(projection));
        glUniformMatrix4fv(
            glGetUniformLocation(lighting_shader_program.ID, "u_view"), 1,
            GL_FALSE, glm::value_ptr(view));

        // world transformation
        glm::mat4 model = glm::mat4(1.0f);
        glUniformMatrix4fv(
            glGetUniformLocation(lighting_shader_program.ID, "u_model"), 1,
        ...
        glUniformMatrix4fv(
            glGetUniformLocation(light_cube_shader_program.ID, "u_projection"),
            1, GL_FALSE, glm::value_ptr(projection));
        glUniformMatrix4fv(
            glGetUniformLocation(light_cube_shader_program.ID, "u_view"), 1,
            GL_FALSE, glm::value_ptr(view));
        ...
        glUniformMatrix4fv(
            glGetUniformLocation(light_cube_shader_program.ID, "u_model"), 1,
            GL_FALSE, glm::value_ptr(model));
